...
class Autoblog_Module_Backend extends Autoblog_Module {
	...
	public function register_admin_menu() {
		...
		// autoblog menu
		$page_title = __( 'RSS AutoBlog', 'autoblogtext' );
		...
		$page_title = __( 'RSS AutoBlog Dashboard', 'autoblogtext' );
		...
		// all feeds page
		$page_title = __( 'Alle Feeds', 'autoblogtext' );
		...
		// addons page
		$page_title = __( 'RSS AutoBlog Erweiterungen', 'autoblogtext' );
		$menu_title = __( 'Erweiterungen', 'autoblogtext' );
		if ( $is_network_admin ) {
