<?php
/*
Addon Name: Text an Beiträge anhängen
Description: Ermöglicht das Anhängen von Text an jeden Beitrag mit variablen Platzhaltern
Author: PSOURCE
...
class A_appendtexttopost extends Autoblog_Addon {
	...
	public function add_footer_options( $key, $details ) {
		...
		$label = sprintf(
			...
			__( 'Fußzeilentext posten', 'autoblogtext' ),
			__( 'Du kannst die folgenden Platzhalter in der Fußzeile verwenden:', 'autoblogtext' ),
		...
		// render block header
		$this->_render_block_header( __( 'Füge Text zum Posten von Inhalten hinzu', 'autoblogtext' ) );
